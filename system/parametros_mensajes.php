...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="tableOscura">
	...
	if ($mod_tip)
	{
		include(_FILE_PHP_ABM_PARAMETROS);
	}
	if ($errors)
	{
	...
	echo "<tr class='tableClara'>
					<td align='right'>
						<input type='button' value='Cerrar' class='botonForm' onclick=\"parent.Windows.close('panel_control');\">	
					</td> 
					<td align='left'>
					<input type='button' value='Volver' class='botonForm' onclick=\"history.back();\">
