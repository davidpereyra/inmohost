<?xml version="1.0" encoding="iso-8859-1"?><!-- DWXMLSource="http://atilio/inmohostV2.0/system/datos/agenda_tasaciones_new.xml.php?usr_id=908&dia=14&mes=06&ano=2007" -->
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr >
    ...
    <td width="50%"><h1 align="right" onclick="position(event); toolTip('{$fileCalendario}&amp;destino=citasListado&amp;acc_internet=$acc_internet',this);"><a title="buscar fecha" ><img src="../interfaz/inmohost/images/iconos/calendario.gif" width="16" height="15" hspace="5" align="absmiddle" />buscar fecha&nbsp;&nbsp;&nbsp;</a></h1></td>
  </tr>
  ...
  <tr>
    <td colspan="2"><table width="99%" border="0" align="center" cellpadding="1" cellspacing="1" class="tableOscura">
      ...
      <xsl:for-each select="XML/hora">
        <tr class="tableClara">
          <td><div align="center"><a href="javascript:;" onclick="position(event); toolTip('{$fileAgendaCitasNew}&amp;usr_id={$usr_id}&amp;hora={@id}&amp;fecha={../datos/ano}-{../datos/mes}-{../datos/dia}&amp;prp_id={$prp_id}',this);" title="Agendar Cita en este Horario"><img src="../interfaz/inmohost/images/iconos/20/citas.png" width="20" height="20" border="0" /></a></div></td>
          <td><div align="center">
          ...
          <td colspan="9"><xsl:for-each select="item">
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tr1" style="margin-top:2px;">
                <tr class="tableClara">
                  ...
                  <td width="50"><div align="center"><a href="javascript:;" onclick="position(event); toolTip('{$fileAgendaCitasInteresados}&amp;param={@cita_id}',this);" title="Agregar Interesado"><img src="../interfaz/inmohost/images/iconos/20/vercitas.png" width="20" height="20" border="0" /></a></div></td>
                  </tr>
                      </table>
          </xsl:for-each></td>
          </tr>
