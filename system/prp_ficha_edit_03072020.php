...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <?php
    if( (hayInternet() && $mod_tip=="add") || $mod_tip=="edit"){ // si es un Alta y Hay Internet  -OR-  estamos editando un id
...
}//if si intentamos dar de alta sin internet
else{
	echo "<H2><br><br><br><b>&nbsp;&nbsp;&nbsp;NO hay Internet, por favor intente cargar el inmueble mas tarde.</b></H2";
}
