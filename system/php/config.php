...
//	echo "REMOTE_ADDR: ".$_SERVER['REMOTE_ADDR']."<br>dominio_local: ".$dominio_local."<br> con_ip: ".$con_ip."<br>";

	@session_start('inmohost'); 
	
	if ($_SESSION["acceso_remoto"])//($con_ip!="192"&&$con_ip!="127") if ($con_ip!="192"&&$con_ip!="127")
