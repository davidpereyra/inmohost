...
// MM_XSLTransform errors 	
	'MM_GEN_ERROR' =>  'Error de MM_XSLTransform.<br>',
	'MM_NO_PROCESSOR_ERROR' =>  'El servidor no pudo ejecutar la transformación XSL porque no se encontró el procesador XSLT para PHP. Póngase en contacto con el administrador del servidor y pídale que instale un procesador XSLT para PHP.',
	'MM_XML_EMPTY_ERROR' =>  'El origen XML no puede estar vacío.',
	'MM_XSL_EMPTY_ERROR' =>  'El origen XSLT no puede estar vacío.',
	'MM_OPEN_REMOTE_ERROR' =>  'Error al abrir %s.',
	'MM_HTTPS_OPEN_ERROR' =>  'Error al abrir %s. Causas posibles: el URL es incorrecto o no se admite OpenSSL.',
	'MM_HTTPS_NOT_SUPPORTED_ERROR' =>  'Error al abrir %s. El protocolo HTTPS se admite a partir de PHP 4.3.0.',
	'MM_OPEN_FILE_ERROR' =>  'No se encontró el archivo %s especificado.',
	'MM_FILE_NOT_READABLE_ERROR' =>  'No se puede leer el archivo %s especificado.',
	'MM_INVALID_XML_ERROR' =>  '%s no es un documento XML v&aacute;lido.<br>',
	'MM_CHECK_VALID_SAB_ERROR' =>  ' en archivo %s<br>',
	'MM_CHECK_VALID_D4_TAG_ERROR' =>  ' etiqueta %s,',
	'MM_CHECK_VALID_D4_ERROR' =>  'Compruebe%s línea %s, columna %s en archivo %s.<br>',
	'MM_CHECK_VALID_D5_ERROR' =>  ' en archivo %s.<br>',
	'MM_TRANSFORMATION_ERROR' =>  'Error de transformación.<br>',
	'MM_TRANSFORM_SAB_ERROR' =>  ' en archivo %s<br>',
	'MM_TRANSFORM_D4_ERROR' =>  ' en archivo %s<br>',
	'MM_TRANSFORM_D5_ERROR' =>  ' en archivo %s<br>',
// /MM_XSLTransform errors
