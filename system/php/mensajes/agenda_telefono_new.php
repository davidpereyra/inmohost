...
if ($mod_edit == "1") {
			$titulo = "Modificar Tel&eacute;fono"; //
			$destino1 = ""; // listadoPropiedades
			$url1 = "";
			$parametros = "mod_edit";
} else {
			$titulo = "Agregar Tel&eacute;fono"; //
			$destino1 = ""; // listadoPropiedades
			$url1 = "";
			$parametros = "mod_new";
}
...
<form id="agendaTelAgregar" name="agendaTelAgregar" method="post" action="<?php print _FILE_PHP_ABM_MENS_TELS;?>" style="height:100%" >
...
?>
    ...
    <tr class="tableClara" >
      <td align="center"><div align="right" id="telefono_div">Tel&eacute;fono:</div></td>
      <td><span id="div_telefono"><input name="telefono" type="text" id="telefono" tabindex="13" size="10" maxlength="20" /></span></td>
    </tr>
    <tr class="tableClara" >
