...
<form id="controlInmo" name="controlInmo" method="post" action="<?php print _FILE_PHP_MENSAJES;?>">
<input type="hidden" name="mod_tip" value="<?echo $mod_tip?>" />  
<input type="hidden" name="nomVentana" value="<?echo $nomVentana?>"/>  
<input type="hidden" name="fileABM" value="<?echo _FILE_PHP_ABM_INMO?>"/>
...
<?php
	...
	if(isset($fileXML) && isset($fileXSL)){
		...
		$new_xsl->setXML($fileXML."?mod_tip=$mod_tip");
