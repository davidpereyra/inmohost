	...
	if($mod_tip=="edit")
	{
		...
		$ficha_nueva=@mysql_result($rs_ficha_nueva,0,0);
			...
			if (mysql_num_rows($cons_prop)){
				...
				$prp_lat=$cons_prp[prp_lat];
				$prp_lng=$cons_prp[prp_lng];
				$prp_plano=$cons_prp[prp_plano];
				$prp_visibilidad=$cons_prp[prp_visibilidad];
...
*/
			...
			<propiedad>
		        ...
		        <prp_anonimo><![CDATA[$prp_anonimo]]></prp_anonimo>
		        <prp_lat><![CDATA[$prp_lat]]></prp_lat>
		        <prp_lng><![CDATA[$prp_lng]]></prp_lng>
				<prp_plano><![CDATA[$prp_plano]]></prp_plano>
				<prp_visibilidad><![CDATA[$prp_visibilidad]]></prp_visibilidad>
		        ";
