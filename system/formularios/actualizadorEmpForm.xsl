...
<xsl:for-each select="XML/emp/item">
  <tr class="tableClara">
    <td><div align="center"><xsl:value-of select="nombre" disable-output-escaping="yes" /></div></td>
    <td><div align="center"><xsl:value-of select="./cambio_det" disable-output-escaping="yes" /></div></td>
    <td><div align="center"><a href="javascript:;" class="menu" onclick="position(event); toolTip('{$file0}&amp;emp_id={emp_id}&amp;cambio_id={cambio_id}',this)">ver</a></div></td>
