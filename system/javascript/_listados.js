						...
						if(label == 'prp_citas') {
							...
							if(dato == '0') {
								...
								img ="20/ficha.png";
									...
									{
										case 'mod_edit':
											urlLink = "ventana('prp_ficha', '&mod_edit=1&mod_tip=edit&prp_id="+prp_id+"&usr_id="+_USR_ID+"', 'system/prp_ficha_edit.php', 'Modificar Propiedad - ID:"+prp_id+"');";	
										break;
										case 'mod_del':
											urlLink = "ventana('prp_ficha', '&mod_edit=1&prp_id="+prp_id+"&usr_id="+_USR_ID+"', 'system/prp_ficha.php', 'Ficha de Propiedad');";
										break;
										case 'mod_search':
											urlLink = "ventana('prp_ficha', '&mod_edit=1&prp_id="+prp_id+"&usr_id="+prp_inmoID+"', 'system/prp_ficha.php', 'Ficha de Propiedad');";
										break;
										default:
										return false;
									}//switch
