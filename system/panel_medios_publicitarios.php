...
<?php if($mod == 'listado'){ ?>
	...
	<script language="javascript" type="text/javascript">
		...
		var prpFileListado = "<?php echo _FILE_XML_PANEL_MEDIOSPUBLICITARIOS_LISTADO; ?>";
	</script>
...
<body <?php if($mod == 'listado') echo "onload=\"cargoXML('"._FILE_XML_PANEL_MEDIOSPUBLICITARIOS_HEAD."', 'HeadResultados', 'ListadoResultado', '', 'head');\""; ?>>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<td valign="top" id="tdContendios">
<?php if($mod == 'listado'){ ?>
<div align="center" id="listadoDatos">
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr>
    <td><a></a>      <div align="right">
